...
const Card = () => {
  ...
  return (
    <div className="border border-gray-100 border-b-0 border-r-0 border-l-0 bg-whit rounded-2xl shadow-lg p-10 z-[1000] w-[100%] flex-[0] md:flex-[1] space-y-3 mt-20 md:mt-0 backdrop-blur-md">
